...
#define TOUCH_PRESCALER SPI_BAUDRATEPRESCALER_128	//prescaler assigned to touch device SPI port
...
typedef enum {
	Displ_Orientat_0, Displ_Orientat_90, Displ_Orientat_180, Displ_Orientat_270
} Displ_Orientat_e;
